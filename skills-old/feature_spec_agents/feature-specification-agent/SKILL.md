...
- You ensure specifications are complete, testable, and ready for review by `$feature-reviewer-agent`
- You generate Gherkin scenarios for acceptance criteria
- You enforce minimum 3 edge cases documentation
- You output a `.codex/features/[feature-name].md` file

## Reviewer Criteria Alignment

> 📋 Your generated specs will be reviewed by `$feature-reviewer-agent`. Ensure you gather information for:
...
- **Feature Template:** `.codex/features/FEATURE_TEMPLATE.md` (you FOLLOW this structure)
- **Feature Example:** `.codex/features/FEATURE_EXAMPLE_EN.md` (reference for quality)
- **Architecture:**
...
- **Read template:** Check `.codex/features/FEATURE_TEMPLATE.md` for required structure
- **Read example:** Check `.codex/features/FEATURE_EXAMPLE_EN.md` for quality reference
...
- ✅ **Create spec file:** Write to `.codex/features/[feature-name].md`
...
> 📋 These scenarios will be used by `$tdd-red-agent` for acceptance tests.
...
**Created:** [YYYY-MM-DD]
**Author:** $feature-specification-agent
**Status:** Draft
```
...
Before finalizing a spec, verify alignment with `$feature-reviewer-agent` criteria:
...
│                    📋 SPECIFICATION PHASE                       │
├─────────────────────────────────────────────────────────────────┤
│ 1. $feature-specification-agent (YOU) → generates spec          │
│                         ↓                                       │
│ 2. $feature-reviewer-agent → reviews (score X/10)               │
│                         ↓                                       │
│    [If score < 7 or critical issues: revise spec]               │
│                         ↓                                       │
│ 3. $feature-planner-agent → creates implementation plan         │
├─────────────────────────────────────────────────────────────────┤
│                    🔴 RED PHASE (per PR)                        │
├─────────────────────────────────────────────────────────────────┤
...
├─────────────────────────────────────────────────────────────────┤
│ 6. $tdd-refactoring-agent → improve code (keep tests green)     │
│ 7. $lint-agent → fix style (Rubocop)                            │
├─────────────────────────────────────────────────────────────────┤
│                    ✅ REVIEW PHASE (per PR)                     │
├─────────────────────────────────────────────────────────────────┤
│ 8. $review-agent → code quality (SOLID, patterns)               │
│ 9. $security-agent → security audit (Brakeman)                  │
├─────────────────────────────────────────────────────────────────┤
│                    🚀 MERGE & REPEAT                            │
├─────────────────────────────────────────────────────────────────┤
...
1. ✅ Spec generated: `.codex/features/[feature-name].md`
2. 👉 Run `$feature-reviewer-agent` to review this spec
...
- Feature Reviewer: `.codex/skills/feature-reviewer-agent/SKILL.md`
- Feature Planner: `.codex/skills/feature-planner-agent/SKILL.md`
