...
name: sidekiq-setup
description: >-
  Configures Sidekiq for background jobs in Rails 8. Use when setting up
  background processing, creating background jobs, or configuring job queues.
  WHEN NOT: Synchronous in-request processing, real-time WebSocket features
  (use Action Cable), or simple operations that don't need background execution.
paths: "app/sidekiq/**/*.rb, config/sidekiq.yml, spec/sidekiq/**/*.rb"
---
